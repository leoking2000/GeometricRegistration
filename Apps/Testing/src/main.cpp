...
// closestPointToTriangleTest

TEST(closestPointToTriangleTest, FaceRegion)
{
    glm::vec3 a(0, 0, 0);
    glm::vec3 b(1, 0, 0);
    glm::vec3 c(0, 1, 0);
    ...
    bool hit = geo::closestPointToTriangle(
        cp,
        dist,
        query,
        a, b, c,
    ...
    ExpectVec3Near(cp, glm::vec3(0.25f, 0.25f, 0.0f));
    EXPECT_NEAR(dist, 1.0f, 1e-5f);
}

TEST(closestPointToTriangleTest, VertexRegionA)
{
    glm::vec3 a(0, 0, 0);
    glm::vec3 b(1, 0, 0);
    glm::vec3 c(0, 1, 0);
    ...
    ExpectVec3Near(cp, a);
    EXPECT_NEAR(dist, glm::sqrt(2.0f), 1e-5f);
}

TEST(closestPointToTriangleTest, VertexRegionB)
{
    glm::vec3 a(0, 0, 0);
    glm::vec3 b(1, 0, 0);
    glm::vec3 c(0, 1, 0);
...
TEST(closestPointToTriangleTest, VertexRegionC)
{
    glm::vec3 a(0, 0, 0);
    glm::vec3 b(1, 0, 0);
    glm::vec3 c(0, 1, 0);
...
TEST(closestPointToTriangleTest, EdgeRegionAB)
{
    glm::vec3 a(0, 0, 0);
    glm::vec3 b(1, 0, 0);
    glm::vec3 c(0, 1, 0);
    ...
    ExpectVec3Near(cp, glm::vec3(0.5f, 0.0f, 0.0f));
    EXPECT_NEAR(dist, 1.0f, 1e-5f);
}

TEST(closestPointToTriangleTest, EdgeRegionAC)
{
    glm::vec3 a(0, 0, 0);
    glm::vec3 b(1, 0, 0);
    glm::vec3 c(0, 1, 0);
    ...
    ExpectVec3Near(cp, glm::vec3(0.0f, 0.5f, 0.0f));
    EXPECT_NEAR(dist, 1.0f, 1e-5f);
}

TEST(closestPointToTriangleTest, EdgeRegionBC)
{
    glm::vec3 a(0, 0, 0);
    glm::vec3 b(1, 0, 0);
    glm::vec3 c(0, 1, 0);
    ...
    ExpectVec3Near(cp, glm::vec3(0.5f, 0.5f, 0.0f));
    EXPECT_NEAR(dist, glm::sqrt(0.5f), 1e-5f);
}

TEST(closestPointToTriangleTest, MaxDistanceReject)
{
    glm::vec3 a(0, 0, 0);
    glm::vec3 b(1, 0, 0);
    glm::vec3 c(0, 1, 0);
    ...
    glm::vec3 query(0.25f, 0.25f, 10.0f);
...
TEST(closestPointToTriangleTest, PointOnTriangle)
{
    glm::vec3 a(0, 0, 0);
    glm::vec3 b(1, 0, 0);
    glm::vec3 c(0, 1, 0);
    ...
    glm::vec3 query(0.25f, 0.25f, 0.0f);
